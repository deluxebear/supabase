  ...
  return (
    <>
      <PageHeader size="default">
        <PageHeaderMeta>
          <PageHeaderSummary>
            <PageHeaderTitle>{$t('Attack Protection')}</PageHeaderTitle>
            <PageHeaderDescription>
              {$t('Configure security settings to protect your project from attacks')}
            </PageHeaderDescription>
          </PageHeaderSummary>
        </PageHeaderMeta>
      </PageHeader>
...
ProtectionPage.getLayout = (page) => (
  <DefaultLayout>
    <AuthLayout title={$t('Attack Protection')}>{page}</AuthLayout>
  </DefaultLayout>
)
